...
HY = {
 ...
 'HERO_P': 'Գրանցում ենք էլեկտրական համակարգի շեղումներն ու իրադարձությունները։ Տվյալների հիման վրա տալիս ենք հստակ ինժեներական գնահատական։',
 ...
 'ASG_CARDS': asg_html([
    ...
    ('02', 'ՀԱՆՁՆՈՒՄ-ԸՆԴՈՒՆՈՒՄ', 'Անկախ ինժեներական գնահատում', 'Կարգաբերումից հետո՝ հանձնման-ընդունման փուլում կամ երաշխիքային ժամկետի ավարտից առաջ, գրանցում և գնահատում ենք համակարգի աշխատանքային պարամետրերն ու էլեկտրաէներգիայի որակի ցուցանիշները։'),
...
PALETTES = {
    ...
    'blue': dict(
        paper='#F3EEE9', hi='#F8F5F1', lo='#E9E3DA', tint='#EDE8E1', tint2='#F7F4F0',
        ph='#DAD2C6', offwhite='#FBF9F6',
