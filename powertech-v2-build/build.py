...
HY = {
 ...
 'F_INTRO': 'Նշեք՝ ինչ է տեղի ունեցել, երբ է դա նկատվել և որ սարքավորման վրա է ազդել։',
 ...
 'F_MSG_PH': 'Կարճ նկարագրեք՝ ինչ է տեղի ունեցել, երբ և որ սարքավորման վրա։',
...
HY_DATA.update({
 ...
 'appTypes': ['Արտադրություն', 'Արևային կայան', 'Բժշկություն / լաբորատորիա',
