...
EN = {
 ...
 'CO_P': 'Gridec is an independent electrical engineering company based in Yerevan. We are a small team focused on specialised engineering work and long-term cooperation with our clients.',
...
HY = {
 ...
 'CO_P': 'Gridec-ը Երևանում գործող անկախ էլեկտրատեխնիկական ընկերություն է։ Մենք փոքր թիմ ենք։ Կենտրոնանում ենք մասնագիտացված ինժեներական աշխատանքի և մեր հաճախորդների հետ երկարաժամկետ համագործակցության վրա։',
 'CO_STORY': story_html([
    # неразрывный пробел перед последним словом: без него «լինի» повисало
    # на третьей строке в одиночестве (63 px при 1440)
    ('01 · ԻՆՉՈՒ ՍԿՍԵՑԻՆՔ',
     'Gridec-ի հիմքում պարզ գաղափար է․ մեր հաճախորդները պետք է կարողանան հասկանալ, թե ինչ է կատարվում իրենց էլեկտրական համակարգում՝ առանց սեփական մասնագիտացված թիմ ունենալու կամ հատուկ չափիչ սարքավորումներ ձեռք բերելու։'),
