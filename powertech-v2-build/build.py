...
HY = {
 ...
 'CO_STORY': story_html([
    ...
    ('01 · ԻՆՉՈՒ ՍԿՍԵՑԻՆՔ',
     'Gridec-ի հիմքում պարզ գաղափար է․ մեր գործընկերները պետք է կարողանան հասկանալ, թե ինչ է կատարվում իրենց էլեկտրական համակարգում՝ առանց սեփական մասնագիտացված թիմ ունենալու կամ հատուկ չափիչ սարքավորումներ ձեռք բերելու։'),
