# ОТРАБОТАЛ ЧАСТИЧНО. Принятое состояние героя — светлое поле, исходная физика и
# кольцо величин — перенесено в shell.html. Здесь остаётся отклонённое: тёмная
# плита с кубами, шестиугольная форма, прорези по швам. Хранится как запись
# отвергнутых направлений, к нынешнему шаблону не применяется.
